...
public class Memory {
    ...
    private static final String sharedpref = "com.snatik.matches";
    ...
    public static void save(int theme, int difficulty, int stars) {
        ...
        if (stars > highStars) {
            SharedPreferences sharedPreferences = Shared.context.getSharedPreferences(sharedpref,
    ...
    public static int getBestTime(int theme, int difficulty) {
        ...
        SharedPreferences sharedPreferences = Shared.context.getSharedPreferences(sharedpref, Context.MODE_PRIVATE);
