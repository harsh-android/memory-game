...
public class PopupManager {
	...
	public static void showPopupSettings() {
		RelativeLayout popupContainer = (RelativeLayout) Shared.factivity.findViewById(R.id.popup_container);
	...
	public static void closePopup() {
		final RelativeLayout popupContainer = (RelativeLayout) Shared.factivity.findViewById(R.id.popup_container);
